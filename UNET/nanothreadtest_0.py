...
def main():
    ...
    trained_model_file_name = "nano0_results.txt" #EDIT CONTAINS JETSON NUMBER
   ...
   # model = TrainingLoop(2, 1, .0001, trained_model_file_name)
    ...
    #REPLACING TRAINING FOR THREAD TEST PURPOSES
    with open(trained_model_file_name, 'w') as f:
        f.write('x=6')
